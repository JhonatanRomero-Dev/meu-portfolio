...
import fotoProfissional from './img/fotoprofisional.jpeg';
  ...
  return (
    ...
    >
      ...
      <p className="text-xl text-gray-300 max-w-2xl mb-8 leading-relaxed">
        ...
        apaixonado por tecnologia e em busca da minha primeira oportunidade
        de estágio na área de TI. Estou sempre explorando novas ferramentas
        e frameworks para expandir meus conhecimentos e habilidades.
      </p>
      ...
      >
        <Button
          ...
          className="bg-white text-black hover:bg-gray-200 shadow-lg transform hover:scale-105 transition-transform duration-300"
        >
